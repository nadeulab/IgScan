...
To run the preprocessing workflow, first copy or clone the [`BulkNGS_preprocessing/`](https://github.com/ianmarquezlopez/IgScan/tree/main/BulkNGS_preprocessing) directory located within the IgScan package to a directory on your system where you have permission to execute and write files.
