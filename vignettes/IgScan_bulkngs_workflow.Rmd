...
```
##   SampleID                        VDJ_genes       Junction_aa Contamination_FLAG Contamination_Freq Contamination_Sample
...
## 5  Sample2 IGHV2-70*01/IGHD3-10*01/IGHJ4*02 CARTLYYYGSGSTFDYW               PASS                 NA                 <NA>
```
...
![plot of chunk plot_tree](images/plot_tree-1.png)
